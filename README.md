...
[![My Skills](https://skillicons.dev/icons?i=html,linux,js,python,sqlite,mysql,sublime,arch,bash,discord,bots,vscode,kali,debian,github,git,nodejs,react,linkedin)](https://skillicons.dev)
